...
Start with the forward simulator to see the mechanochemical primitives on their
own, then train a learned emulator to assemble a target morphology. The two
